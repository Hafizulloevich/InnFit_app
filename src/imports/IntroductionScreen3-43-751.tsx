import svgPaths from "./svg-2oyn1mlp4x";
...
function NextButton() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="next button">
      <div className="[grid-area:1_/_1] bg-[rgba(255,103,104,0)] h-[27px] ml-[20px] mt-0 rounded-[100px] w-[65px]" />
      <p className="[grid-area:1_/_1] font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] ml-[53.5px] mt-[3px] relative text-[#0088ff] text-[18px] text-center text-nowrap translate-x-[-50%] whitespace-pre">Get Started</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[calc(50%+6px)] top-[791px] translate-x-[-50%] w-[345px]">
      <p className="font-['Montserrat:SemiBold',sans-serif] font-semibold h-[22.846px] leading-[normal] relative shrink-0 text-[#c4c4c4] text-[18px] text-center w-[44px]">Prev</p>
      <Circle />
      <NextButton />
    </div>
  );
