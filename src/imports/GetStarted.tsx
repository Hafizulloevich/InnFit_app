import svgPaths from "./svg-iyydfwvg7i";
import imgUnsplashFouVDmGXoPi from "figma:asset/9555383ea1566fa10ba4c3dab201650f4bcc6b60.png";
...
export default function GetStarted() {
  return (
    <div className="bg-white relative size-full" data-name="Get Started">
      <HomeIndicator />
      <div className="absolute h-[852px] left-0 top-px w-[406px]" data-name="unsplash:fouVDmGXoPI">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgUnsplashFouVDmGXoPi} />
      </div>
      <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] h-[370px] left-0 to-[23.671%] to-[rgba(0,0,0,0.63)] top-[482px] w-[390px]" />
      <p className="absolute font-['Montserrat:SemiBold',sans-serif] font-semibold leading-[normal] left-[194.5px] text-[34px] text-center text-white top-[522px] tracking-[0.34px] translate-x-[-50%] w-[315px]">You want Authentic, here you go!</p>
      <p className="absolute font-['Montserrat:Regular',sans-serif] font-normal leading-[1.54] left-[194.5px] text-[#f2f2f2] text-[14px] text-center top-[656px] tracking-[0.14px] translate-x-[-50%] w-[315px]">Find it here, buy it now!</p>
      <Frame />
